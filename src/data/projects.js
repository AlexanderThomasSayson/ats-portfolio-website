export const projects = [
  {
    ...
    problem:
      "Maintaining Yamaha’s brand image is critical, yet dealers previously lacked a structured way to report issues that directly affected branding and customer perception—such as color fading, damaged signage, faulty appliances, and other visual or operational concerns at dealer locations. Before the system was introduced, Yamaha Philippines relied on a manual and fragmented ticketing process, resulting in delayed responses, misplaced reports, and limited visibility into issue status and resolution timelines. With no standardized reporting workflow, dealers struggled to escalate branding concerns efficiently, while support teams faced challenges in prioritization, tracking, and accountability across the nationwide dealer network.",
    solution:
    ...
    challenges: [
      ...
      "Creating a scheduler for automated data synchronization between two different RDS",
      "Implementing data reports for each officers and managers",
      "Ensuring that each ticket is not processed twice, to avoid duplicates when two officers handle the same ticket",
      "Guaranteed data synchronization across multiple regional offices",
    ],
    outcomes: [
  ...
  },
  {
    ...
    challenges: [
      ...
      "Ensuring web and mobile app performance with heavy image processing",
    ],
    outcomes: [
      "Processed over 1000 jewelry valuations in the first 6 months",
    ...
    screenshots: ["/images/redyoos-page.png", "/images/redyoos/mailkit.png","/images/redyoos/how_it_works.png","/images/redyoos/blog_post.png","/images/redyoos/partnerships.png"],
    role: "Backend Developer",
    duration: "5 months",
    team: "3 developers",
  },
  {
    ...
    title: "Finance Flow",
    shortDescription:
      "A personal finance management app that helps employees break free from the paycheck-to-paycheck cycle using smart budgeting rules and automated tax calculations.",
    image: "/images/financeflow/dashboard.png",
    logo: null,
    size: "laptop",
    technologies: [
      "Next.js",
    ...
    problem:
      "Most employees don't survive the 9-to-5; they survive paycheck to paycheck. Without proper financial planning and money management tools, individuals struggle to allocate their income effectively, often finding themselves broke before the next payday. Many lack awareness of how much they should save, spend, or set aside for emergencies, leading to financial stress and limited ability to handle unexpected expenses or build long-term wealth.",
    solution:
      "I developed Finance Flow, a personal finance management application that implements the 75%-15%-10% budgeting rule to help users manage their income effectively. The app automatically allocates 75% of income for expenses, 15% for savings, and 10% for emergency cushion funds. It features comprehensive loan management to track debts and payment schedules, plus automated tax calculation based on the 2024 Philippine government tax brackets to help users understand their take-home pay and plan accordingly.",
    challenges: [
      "Implementing accurate Philippine tax calculations across different income brackets and employment types",
      "Designing an intuitive budgeting interface that encourages consistent financial discipline",
      "Building a flexible loan management system that handles various interest rates and payment schedules",
      "Creating visual dashboards that make complex financial data easy to understand at a glance",
    ],
    outcomes: [
      "Successfully implemented the 75-15-10 budgeting framework with automated income allocation",
      "Integrated accurate 2024 Philippine tax calculations for precise net income projections",
      "Built comprehensive loan tracking with payment schedules and interest calculations",
      "Delivered an intuitive dashboard that visualizes spending patterns and savings progress",
    ],
    screenshots: ["/images/financeflow/login.png","/images/financeflow/registration.png","/images/financeflow/dashboard.png","/images/financeflow/expenses.png","/images/financeflow/loan_tab.png","/images/financeflow/savings_tab.png","/images/financeflow/budget_config1.png","/images/financeflow/budget_config2.png"],
